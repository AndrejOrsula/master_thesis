...
\begin{figure}[ht]
    ...
    \begin{subfigure}[ht]{0.4115\textwidth}
        ...
        \begin{tabular}{c|ccc}
            ...
            \begin{tabular}[c|]{@{}c@{}}Success\\Rate\end{tabular} & XX\%         & XX\%         & XX\%         \\[4mm]
            \begin{tabular}[c|]{@{}c@{}}Episode\\Length\end{tabular} & XX           & XX           & XX
        \end{tabular}
    ...
    \caption{Success rate of TD3, SAC and TQC algorithms on the created grasping environment. All plots are processed with moving average,~\(n\)~=~\(100\), and exponential smoothing,~\(\alpha\)~=~\(0.002\).}
...
Therefore, this experiment is repeated for an environment where the camera pose is static and remains unchanged throughout the entire training and subsequent evaluation on novel scenes. \hyperref[fig:training_curve_comparison_2d_2_5d_3d_fixed_camera_pose]{\figurename~\ref*{fig:training_curve_comparison_2d_2_5d_3d_fixed_camera_pose}~\&~\tablename~\ref*{tab:training_curve_comparison_2d_2_5d_3d_fixed_camera_pose}} provides results for such environment with reduced domain randomisation.
...
\begin{figure}[ht]
    \centering
    % \includegraphics[width=1.0\textwidth]{experimental_evaluation/.pdf}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[ht]{0.4115\textwidth}
        ...
        \begin{tabular}{c|cc}
            ...
            \begin{tabular}[c|]{@{}c@{}}Success\\Rate\end{tabular} & XX\%         & XX\%           \\[4mm]
            \begin{tabular}[c|]{@{}c@{}}Episode\\Length\end{tabular} & XX           & XX
        \end{tabular}
        \caption*{\textit{Evaluation on novel scenes}}
    \end{subfigure}%
    \captionsetup{labelformat=figure_and_table}
...
\begin{table}[ht]
    ...
    \begin{tabular}{cr|cc}
                                                        ...
                                                        &                & \textbf{UR5}                   & \textbf{Panda} \\ \hline
        \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}Training\end{tabular}} & \textbf{UR5}   & UR5/UR5                        & UR5/Panda      \\
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[ht]{1.0\textwidth}
        ...
        \begin{tabular}{c|ccccccc}
            ...
            \begin{tabular}[c|]{@{}c@{}}Success\\Rate\end{tabular}          & XX\% & XX\% & XX\% & XX\% & XX\% & XX\% & XX\% \\[4mm]

            \begin{tabular}[c|]{@{}c@{}}Episode\\Length\end{tabular}          & XX   & XX   & XX   & XX   & XX   & XX   & XX
        \end{tabular}
        \caption*{\textit{Evaluation on novel scenes}}
    \end{subfigure}%
    \captionsetup{labelformat=figure_and_table}
    ...
    \caption{Success rate of various ablations of the full method with octree observations. (FE -- Feature Extractor)}
