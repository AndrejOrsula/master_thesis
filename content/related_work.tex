...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{related_work/multiple_real_robots.png}
...
\begin{figure}[b]
    \centering
    \includegraphics[width=0.55\textwidth]{related_work/pixel_wise_rl.png}
