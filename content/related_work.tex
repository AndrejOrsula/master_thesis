...
\begin{figure}[ht]
    ...
    \begin{subfigure}[ht]{0.325\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth]{related_work/ocnn_original.png}
        \caption*{Original mesh}
    \end{subfigure}%
    ~
    \begin{subfigure}[ht]{0.325\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth]{related_work/ocnn_binary.png}
        \caption*{Occupancy voxel grid}
    \end{subfigure}%
    ~
    \begin{subfigure}[ht]{0.325\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth]{related_work/ocnn_normals.png}
