...
\begin{figure}[b]
    \centering
    \includegraphics[width=1.0\textwidth]{related_work/multiple_real_robots.png}
    \caption{A setup with fourteen robots used by \citet{levine_learning_2016} to collect 800,000 grasps.}
...
\begin{figure}[b]
    \centering
    \includegraphics[width=0.5\textwidth]{related_work/pixel_wise_rl.png}
    \caption{Example of pixel-wise action space for grasping by \citet{gualtieri_learning_2018}, where red crosses indicate the position for the next action primitive.}
...
\begin{figure}[hb]
    \centering
    \includegraphics[width=0.625\textwidth]{related_work/reproducibility_random_seed.pdf}
