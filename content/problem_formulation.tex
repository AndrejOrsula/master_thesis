...
\begin{table}[ht]
    ...
    \end{tabular}
    \caption{Overview of the reward function that is utilised in this work for the grasping task, where~\(r_{exp}\)~=~\(7\) and each episode has at most 100 time steps.}
    \label{tab:reward_function}
\end{table}


\section{Demonstrations and Curriculum}
